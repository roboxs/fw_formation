 ...
 * @LastEditTime : 2020-02-13 10:20:49
...
#include "hust_fw_formation_control/FWstates.h" //自定义的飞机的状态消息
...
public:
    ...
    hust_fw_formation_control::FWcmd cmd_from_controller; //来自各种控制器的四通道控制量
    ...
    hust_fw_formation_control::FWstates fw_states_form_mavros; //这个是自定义的完整的飞机状态消息
    ...
    //回调函数的作用：开辟新的空间，将消息池中，ROS从PX4中订阅的MAVROS消息以及无人机的消息进行赋值
    ...
    void cmd_from_controller_cb(const hust_fw_formation_control::FWcmd::ConstPtr &msg)
    {
